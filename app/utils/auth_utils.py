...
from utils.constants import TRUESHUFFLE_SESSION_ID_KEY, SESSION_DB_USER_ID_KEY, SESSION_DB_ACCESS_TOKEN_KEY, SESSION_DB_REFRESH_TOKEN_KEY, SESSION_DB_EXPIRES_AT_KEY, SESSION_DB_SCOPE_KEY, SESSION_DB_SESSION_EXPIRY_KEY
...
def validate_session(cookies) -> SpotifyAuth :
    ...
    if (SESSION_DB_USER_ID_KEY not in session_entry
